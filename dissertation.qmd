...
- Complete-data model = the model of scientific interest/the model we would like to fit if we had complete data = model that yields $Q$, the quantity of scientific interest
