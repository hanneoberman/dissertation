...
The type algorithm in question is the imputation algorithm. 
Imputation algorithms are algorithms with the purpose of generating plausible values based on a model of the observed information. 
...
And while there's no doubt I am an interdisciplinarian and an open scientist, I am no longer sure that I am a statistician necessarily.
...
When there are missing values in a dataset, statistical inference cannot be performed. 
With just one incomplete observation, simple statistics such as the mean are mathematically undefined.
...
<!-- %%| fig-cap: test -->
Missing data are annoying because it is impossible to do statistical inferences with incomplete data. 
