...
::: {.callout}
- kwaliteit van imputatie model kun je pas bepalen op basis van complete data model
- meest ingewikkelde nemen, en da checken
- de simpelste nemen zou betekenen dat je systematisch de relaties onderdrukt (b=0 forceren)
- met smc-fcs: we nemen een complete data model aan, en leiden daaruit imputaties af
:::
