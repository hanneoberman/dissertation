...
tussen inspect miss en def imp mods: involve all stakeholders
crips dm (data mining)
...
- Stat evalualtion may not possible IRL? Bias and confidence interval coverage are impossible to determine without a comparative truth (although PPC and bootstrapping allows us to compare with respect to an estimand).
